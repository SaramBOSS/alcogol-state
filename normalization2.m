function normCoeff = normalization2(data)
...
normCoeff = strcat(num2str(S_xy), ',', num2str(S_xz), ',', num2str(S_yz))
%normCoeff = string([S_xy, S_xz, S_yz])
%normkoef = table(S_xy, S_xz, S_yz, 'VariableNames', shapka);
% writetable(T2,fileName)
%save('Norm.mat', 'normkoef');
%disp(normkoef)
